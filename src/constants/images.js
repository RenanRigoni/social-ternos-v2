// IMAGENS PLACEHOLDER — Todas as URLs abaixo são do Unsplash (licença livre para uso comercial).
// Substituir por fotos reais da loja antes de lançamento com o cliente.

export const IMAGES = {
  // Hero: homem com terno escuro, iluminação dramática
  hero: 'https://images.unsplash.com/photo-1507679799987-c73779587ccf?w=1600&q=85&fit=crop',

  // Sobre: alfaiate ajustando terno — artesanato e atendimento personalizado
  about: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=900&q=85&fit=crop',

  // Galeria — 8 imagens, todas relacionadas a ternos e trajes masculinos
  gallery: [
    // 1. Homem em terno escuro — retrato de destaque
    'https://images.unsplash.com/photo-1507679799987-c73779587ccf?w=700&q=85&fit=crop&crop=top',
    // 2. Detalhe de lapela e tecido — close elegante
  ...
  // Ocasiões — 8 imagens, uma por ocasião (todas com trajes sociais)
  occasions: {
    ...
    corporativo: 'https://images.unsplash.com/photo-1560250097-0b93528c311a?w=600&q=85&fit=crop',
    // Batizado e Cerimônias — evento religioso e familiar
